...
import com.kisanswap.kisanswap.product.sell.viewmodel.viewModelFactory.EditProductViewModelFactory
...
fun EditProductScreen(
    ...
    val editProductViewModel: EditProductViewModel = viewModel(factory = EditProductViewModelFactory(firebaseRepository))
...
//                        editProductViewModel.downloadAndCachePhotosAndVideos(product, context)
                        ...
                        price = TextFieldValue(product.price, TextRange(product.price.length))
...
//                                    price = it.copy(it.text.filter { it.isDigit() })
                            ...
                            OutlinedTextField(
                                value = product.tertiaryCategory,
                                onValueChange = { newValue ->
...
/*val editProductViewModel: EditProductScreenViewModel = viewModel(
        factory = EditProductScreenViewModelFactory(firebaseRepository)
    )
